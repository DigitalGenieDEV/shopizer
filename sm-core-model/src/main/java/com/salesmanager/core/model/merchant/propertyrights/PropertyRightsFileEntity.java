package com.salesmanager.core.model.merchant.propertyrights;
...
@NoArgsConstructor 
@Entity
@Table(name = "PROPERTYRIGHTS_FILE", indexes = @Index(columnList = "PROPERTYRIGHTS_FILE_ID, TEMPLETE_ID"))
public class PropertyRightsFileEntity extends SalesManagerEntity<Long, PropertyRightsFileEntity> implements Auditable {

	private static final long serialVersionUID = 1L;
	public final static String DEFAULT_STORE = "DEFAULT";
	
	@Id
	@Column(name = "PROPERTYRIGHTS_FILE_ID", unique = true, nullable = false)
	@TableGenerator(name = "TABLE_GEN", table = "SM_SEQUENCER", pkColumnName = "SEQ_NAME", valueColumnName = "SEQ_COUNT", pkColumnValue = "PROPERTYRIGHTS_FILE_SEQ_NEXT_VAL")
	...
	public PropertyRightsFileEntity(Long templeteId, String fileName, String userName, Long fileSize) {
