...
//        }
    ...
    @PostMapping(value = "/auth/customer_cart/product/{sku}/exclusive_select", produces = { APPLICATION_JSON_VALUE })
    @ApiOperation(httpMethod = "DELETE", value = "Remove a product from a specific cart", notes = "If body set to true returns remaining cart in body, empty cart gives empty body. If body set to false no body ", produces = "application/json", response = ReadableShoppingCart.class)
    @ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
            @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "ko"),
            @ApiImplicitParam(name = "body", dataType = "boolean", defaultValue = "false"), })
    ...
    @PostMapping(value = "/auth/customer_cart/select_all", produces = { APPLICATION_JSON_VALUE })
    @ApiOperation(httpMethod = "DELETE", value = "Select all product from customer cart",  produces = "application/json", response = ReadableShoppingCart.class)
    @ApiImplicitParams({ @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
            @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "ko"),
            @ApiImplicitParam(name = "body", dataType = "boolean", defaultValue = "false"), })
    public ResponseEntity<ReadableCustomerShoppingCart> selectAllCartItem(
            @ApiIgnore Language language,
            @ApiIgnore MerchantStore store,
            HttpServletRequest request,
            HttpServletResponse response
        ...
        ReadableCustomerShoppingCart readableCustomerShoppingCart = customerShoppingCartFacade.selectAllCartItem(customer, store, language);
