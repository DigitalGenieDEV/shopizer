...
public interface OrderProductFacade {
    ...
    Boolean patchDesign(ReadableOrderProduct readableOrderProduct, PersistableOrderProductDesign persistableOrderProductDesign);

    ReadableOrderProductDesign getReadableOrderProductDesignById(Long id, MerchantStore merchantStore, Language language);
