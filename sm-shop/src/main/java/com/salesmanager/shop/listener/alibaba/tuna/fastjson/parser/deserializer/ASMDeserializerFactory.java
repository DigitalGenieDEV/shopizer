...
import com.salesmanager.shop.listener.alibaba.tuna.fastjson.asm.ASMException;
...
import com.salesmanager.shop.listener.alibaba.tuna.fastjson.util.DeserializeBeanInfo;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, Class<?> clazz, Type type)
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, className, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ASMJavaBeanDeserializer", null);
    ...
    void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        MethodVisitor mw = cw.visitMethod(ACC_PUBLIC, "deserialzeArrayMapping"
                                          , "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;"
                                          , null, null);
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanInt", "(C)I");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == long.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanLong", "(C)J");
                mw.visitVarInsn(LSTORE, context.var(fieldInfo.getName() + "_asm", 2));
            } else if (fieldClass == boolean.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanBoolean", "(C)Z");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == float.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanFloat", "(C)F");
                mw.visitVarInsn(FSTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == double.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanDouble", "(C)D");
                mw.visitVarInsn(DSTORE, context.var(fieldInfo.getName() + "_asm", 2));
            } else if (fieldClass == char.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanString", "(C)Ljava/lang/String;");
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.salesmanager.shop.listener.alibaba.tuna.fastjson.asm.Type.getType(getDesc(fieldClass)));
                mw.visitVarInsn(ALOAD, 1);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "getSymbolTable",
                                   "()Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/SymbolTable;");
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanEnum",
                                   "(Ljava/lang/Class;Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/SymbolTable;C)Ljava/lang/Enum;");
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitLdcInsn(com.salesmanager.shop.listener.alibaba.tuna.fastjson.asm.Type.getType(getDesc(fieldClass)));
                    mw.visitVarInsn(BIPUSH, seperator);
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanStringArray",
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    if (i == 0) {
                        mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONToken", "LBRACKET", "I");
                    } else {
                        mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONToken", "COMMA", "I");
                    }
                    mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONToken", "LBRACKET", "I");
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "accept", "(II)V");
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(com.salesmanager.shop.listener.alibaba.tuna.fastjson.asm.Type.getType(getDesc(itemClass)));
                    mw.visitVarInsn(ALOAD, 3);
                    mw.visitMethodInsn(INVOKESTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/util/ASMUtils", "parseArray",
                                       "(Ljava/util/Collection;" //
                                               + "Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ObjectDeserializer;" //
                                               + "Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser;" //
                ...
                if (!last) {
                    ...
                    mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONToken", "RBRACKET", "I");
                    mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONToken", "EOF", "I");
                }
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "accept", "(II)V");
                continue;
            }
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONToken", "COMMA", "I");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "nextToken", "(I)V");
    ...
    void _deserialze(ClassWriter cw, Context context) {
...

        {
            ...
            mw.visitVarInsn(ALOAD, context.var("lexer"));
            mw.visitMethodInsn(INVOKESPECIAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "isSupportArrayToBean",
                               "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexer;)Z");
            mw.visitJumpInsn(IFEQ, next_);
            //isSupportArrayToBean
            
            mw.visitVarInsn(ALOAD, context.var("lexer"));
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "token", "()I");
            mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONToken", "LBRACKET", "I");
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanType", "(Ljava/lang/String;)I");

        mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "NOT_MATCH", "I");
        mw.visitJumpInsn(IF_ICMPEQ, super_);

        mw.visitVarInsn(ALOAD, 1); // parser
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "getContext",
                           "()Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParseContext;");
...

        {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "setContext",
                               "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParseContext;Ljava/lang/Object;Ljava/lang/Object;)Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParseContext;");
            mw.visitVarInsn(ASTORE, context.var("childContext"));
        }

        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "matchStat", "I");
        mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "END", "I");
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class //
                ...
                if (fieldClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, context.var("lexer"));
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "stringDefaultValue",
                                       "()Ljava/lang/String;");
                } else {
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanFieldBoolean", "([C)Z");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
            } else if (fieldClass == byte.class) {
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanFieldInt", "([C)I");
                mw.visitVarInsn(ISTORE, context.var(fieldInfo.getName() + "_asm"));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanFieldLong", "([C)J");
                mw.visitVarInsn(LSTORE, context.var(fieldInfo.getName() + "_asm", 2));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanFieldFloat", "([C)F");
                mw.visitVarInsn(FSTORE, context.var(fieldInfo.getName() + "_asm"));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanFieldDouble", "([C)D");
                mw.visitVarInsn(DSTORE, context.var(fieldInfo.getName() + "_asm", 2));
                ...
                mw.visitVarInsn(ALOAD, 0);
                mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_prefix__", "[C");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanFieldString",
                                   "([C)Ljava/lang/String;");
                mw.visitVarInsn(ASTORE, context.var(fieldInfo.getName() + "_asm"));
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanFieldSymbol",
                                   "([CLcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/SymbolTable;)Ljava/lang/String;");
                mw.visitInsn(DUP);
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(com.salesmanager.shop.listener.alibaba.tuna.fastjson.asm.Type.getType(getDesc(fieldClass))); // cast
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "scanFieldStringArray",
        ...
        mw.visitVarInsn(ALOAD, 3);
        mw.visitVarInsn(ALOAD, context.var("instance"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "parseRest",
                           "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
        ...
        mw.visitVarInsn(ALOAD, 2);
        mw.visitVarInsn(ALOAD, 3);
        mw.visitMethodInsn(INVOKESPECIAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "deserialze",
                           "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;");
        mw.visitInsn(ARETURN);
    ...
    private void _isEnable(Context context, MethodVisitor mw, Feature feature) {
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/Feature", feature.name(), "Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/Feature;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "isEnabled", "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/Feature;)Z");
    }

    private void defineVarLexer(Context context, MethodVisitor mw) {
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "getLexer", "()Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexer;");
        mw.visitTypeInsn(CHECKCAST, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase"); // cast
    ...
    private void _createInstance(Context context, MethodVisitor mw) {
        ...
        if (Modifier.isPublic(defaultConstructor.getModifiers())) {
            ...
            mw.visitVarInsn(ALOAD, 0);
            mw.visitVarInsn(ALOAD, 1);
            mw.visitMethodInsn(INVOKESPECIAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "createInstance",
                               "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser;)Ljava/lang/Object;");
            mw.visitTypeInsn(CHECKCAST, getType(context.getClazz())); // cast
            mw.visitVarInsn(ASTORE, context.var("instance"));
        }
    }
    ...
    private void _setContext(Context context, MethodVisitor mw) {
        ...
        mw.visitVarInsn(ALOAD, context.var("context"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "setContext",
                           "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParseContext;)V");
        ...
        mw.visitVarInsn(ALOAD, context.var("childContext"));
        mw.visitVarInsn(ALOAD, context.var("instance"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParseContext", "setObject", "(Ljava/lang/Object;)V");
    ...
    private void _deserialize_endCheck(Context context, MethodVisitor mw, Label reset_) {
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "token", "()I");
        mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONToken", "RBRACE", "I");
        mw.visitJumpInsn(IF_ICMPNE, reset_);
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "matchField", "([C)Z");
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONLexerBase", "token", "()I");
        mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/JSONToken", "NULL", "I");
        ...
        mw.visitMethodInsn(INVOKEINTERFACE, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ObjectDeserializer", "getFastMatchToken", "()I");
        ...
        { // setContext
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "setContext",
                               "(Ljava/lang/Object;Ljava/lang/Object;)Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParseContext;");
            mw.visitInsn(POP);
        }
        ...
        mw.visitFieldInsn(GETFIELD, context.getClassName(), fieldInfo.getName() + "_asm_list_item_deser__",
                          "Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ObjectDeserializer;");
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.salesmanager.shop.listener.alibaba.tuna.fastjson.asm.Type.getType(getDesc(itemType)));
        mw.visitVarInsn(ILOAD, context.var("i"));
        mw.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
        mw.visitMethodInsn(INVOKEINTERFACE, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ObjectDeserializer", "deserialze",
                           "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser;Ljava/lang/reflect/Type;Ljava/lang/Object;)Ljava/lang/Object;");
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitVarInsn(ALOAD, context.var(fieldInfo.getName() + "_asm"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "checkListResolve",
    ...
    private void _getCollectionFieldItemDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> itemType) {
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "getConfig", "()"
                                                                                         + "Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParserConfig;");
        mw.visitLdcInsn(com.salesmanager.shop.listener.alibaba.tuna.fastjson.asm.Type.getType(getDesc(itemType)));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParserConfig", "getDeserializer",
                           "(Ljava/lang/reflect/Type;)Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ObjectDeserializer;");
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "getResolveStatus", "()I");
        mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "NeedToResolve", "I");
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "getLastResolveTask",
                           "()Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser$ResolveTask;");
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "getContext", "()"
                                                                                          + "Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParseContext;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser$ResolveTask"
                           , "setOwnerContext"
                           , "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParseContext;)V");
        ...
        mw.visitVarInsn(ALOAD, 0);
        mw.visitLdcInsn(fieldInfo.getName());
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "getFieldDeserializer",
                           "(Ljava/lang/String;)Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/FieldDeserializer;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser$ResolveTask", "setFieldDeserializer",
                           "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/FieldDeserializer;)V");

        mw.visitVarInsn(ALOAD, 1);
        mw.visitFieldInsn(GETSTATIC, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "NONE", "I");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser", "setResolveStatus", "(I)V");
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass) {
        ...
        if (fieldInfo.getFieldType() instanceof Class) {
            mw.visitLdcInsn(com.salesmanager.shop.listener.alibaba.tuna.fastjson.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        } else {
            mw.visitVarInsn(ALOAD, 0);
            mw.visitLdcInsn(fieldInfo.getName());
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "getFieldType",
    ...
    public FieldDeserializer createStringFieldDeserializer(ParserConfig mapping, Class<?> clazz, FieldInfo fieldInfo)
...

        {
            MethodVisitor mw = cw.visitMethod(ACC_PUBLIC //
                                              , "<init>" //
                                              , "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParserConfig;Ljava/lang/Class;Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/util/FieldInfo;)V", null, null);
            mw.visitVarInsn(ALOAD, 0);
            mw.visitVarInsn(ALOAD, 1);
            mw.visitVarInsn(ALOAD, 2);
            mw.visitVarInsn(ALOAD, 3);
            mw.visitMethodInsn(INVOKESPECIAL, getType(superClass), "<init>"
                               , "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParserConfig;Ljava/lang/Class;Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/util/FieldInfo;)V");
    ...
    private void _init(ClassWriter cw, Context context) {
        ...
        MethodVisitor mw = cw.visitMethod(ACC_PUBLIC, "<init>", "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParserConfig;Ljava/lang/Class;)V", null, null);
        mw.visitVarInsn(ALOAD, 0);
        mw.visitVarInsn(ALOAD, 1);
        mw.visitVarInsn(ALOAD, 2);
        mw.visitMethodInsn(INVOKESPECIAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "<init>",
                           "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/ParserConfig;Ljava/lang/Class;)V");

        mw.visitVarInsn(ALOAD, 0);
        mw.visitFieldInsn(GETFIELD, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ASMJavaBeanDeserializer", "serializer",
                          "Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/ASMJavaBeanDeserializer$InnerJavaBeanDeserializer;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/deserializer/JavaBeanDeserializer", "getFieldDeserializerMap",
                           "()Ljava/util/Map;");
        mw.visitInsn(POP);
    ...
    private void _createInstance(ClassWriter cw, Context context) {
        MethodVisitor mw = cw.visitMethod(ACC_PUBLIC, "createInstance"
                                          , "(Lcom/salesmanager/shop/listener/alibaba/tuna/fastjson/parser/DefaultJSONParser;Ljava/lang/reflect/Type;)Ljava/lang/Object;",
                                          null, null);
