package com.salesmanager.shop.populator.search;
...
public class ReadableSearchProductV2Populator  extends
        AbstractDataPopulator<Product, ReadableSearchProductV2> {
    ...
    @Override
    protected ReadableSearchProductV2 createTarget() {
        return null;
    }

    @Override
    public ReadableSearchProductV2 populate(Product source, ReadableSearchProductV2 target, MerchantStore store, Language language) throws ConversionException {
        ...
        try {
            ...
            if(target==null) {
                target = new ReadableSearchProductV2();
            }
