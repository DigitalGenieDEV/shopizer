...
public interface UserMenuRepository extends JpaRepository<UserMenu, Integer> {
	...
	@Query(value = "WITH RECURSIVE MENU_CTE AS (    		\r\n"
			+ "	SELECT     \r\n"
			+ "		  ID, PARENT_ID, MENU_NAME, URL, MENU_DESC, ORD, VISIBLE, MEMBER_TARGET, LINK_TARGET\r\n"
			+ "	    , TOP, SIDE, NAVI, TAB \r\n"
	...
	@Query(value = " SELECT \r\n"
			+ "		ID, PARENT_ID, MENU_NAME, URL, MENU_DESC, ORD, VISIBLE, MEMBER_TARGET, LINK_TARGET, TOP,SIDE, NAVI, TAB  \r\n"
			+ " FROM USERMENU A \r\n" 
