 ...
 * 
 */
package com.salesmanager.core.business.alibaba.rawsdk.client.http;
...
import com.salesmanager.core.business.alibaba.rawsdk.util.SignatureUtil;
...
public final class HttpSupport {
	...
	public static URL buildGetRequestUrl(ClientPolicy clientPolicy, InvokeContext context, Map<String, Object> params)
		...
		int port = clientPolicy.getHttpsPort();
