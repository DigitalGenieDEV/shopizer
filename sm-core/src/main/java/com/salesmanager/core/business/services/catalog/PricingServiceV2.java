...
public interface PricingServiceV2 {
	 ...
	 */
	FinalPrice calculateProductPrice(Product product, Boolean isShowProductPriceCurrencyCode) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	FinalPrice calculateProductPrice(ProductAvailability product, Boolean isShowProductPriceCurrencyCode) throws ServiceException;
